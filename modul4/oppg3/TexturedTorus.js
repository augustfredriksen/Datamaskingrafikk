...
import { Torus } from '../../base/shapes/TorusTextured.js';
...
export class CompositeTexturedHouse {
    ...
    constructor(app) {
        ...
        this.Torus = new Torus(app, {red:0.8, green:0.0, blue:0.6, alpha:1}, false);
    ...
    draw(shaderInfo, textureShaderInfo, elapsed, modelMatrix = new Matrix4()) {
        ...
        this.Torus.draw(textureShaderInfo, elapsed, modelMatrix);
        //Tømmer stacken ...:
        this.stack.empty();
    }
}
